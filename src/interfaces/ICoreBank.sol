...
interface ICoreBank is IERC4626 {
    ...
    function scheduleAddBank(address bank, uint256 delay) external;
    ...
    function scheduleUpdateAllocations(BankAllocation[] calldata newBankAllocations, uint256 delay) external;
    ...
    function scheduleReallocate(address[] calldata withdrawBanks, uint256[] calldata withdrawAmounts, address[] calldata depositBanks, uint256[] calldata depositAmounts, uint256 delay) external;
    ...
    event ReallocateScheduled(address[] withdrawBanks, uint256[] withdrawAmounts, address[] depositBanks, uint256[] depositAmounts, uint256 delay, bytes32 indexed operationId);
